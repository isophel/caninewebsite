				...
				<div class="footer-bottom">
					<div class="container">
						<div class="branding pull-left">
							<img src="./images/logo2.png" alt="Company Name" style="max-height: 80px;" class="logo">
							<h1 class="site-title"><a href="index.php">Canine Safaris ltd</a></h1>
							<small class="site-description">Travel and Traverse</small>
						</div>

						<div class="contact-links ">
							<a href="https://goo.gl/maps/AWuJTnbd4MHDibXp8" target="_blank"><i class="fa fa-map-marker"></i> Plot 24 High Street opposite Adit house near Umeme Regional Offices 2nd Floor Mbarara,Uganda</a>
							<a href="tel:+256776521157"><i class="fa fa-phone"></i> +256 776521157</a>
							<a href="mailto:info@caninesafaris.com"><i class="fa fa-envelope"></i> info@caninesafaris.com</a>
						</div>
					</div>
				</div>
				<div class="colophon">
					<div class="container">
						<center><p class="copy"> &#169;Copyright <?php echo date("Y"); ?> Canine Safaris ltd,All right reserved.</p></center>
					</div>
				</div>
			</footer> <!-- .site-footer -->
