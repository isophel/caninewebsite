...
<?php require_once( ROOT_PATH . '/includes/registration_login.php') ?>
			...
			<main class="content">
				<div class="slider">
					<ul class="slides">
						<li data-background="dummy/lion.jpg" style="background-repeat: no-repeat; background-size: cover;">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Wildlife Safaris</h2>
									<p>Watch the Big 5 and other primates in their natural habitats</p>
								</div>
							</div>
						</li>
						<li data-background="dummy/hiking.jpeg" style="background-repeat: no-repeat; background-size: cover;">
							<div class="container">
								<div class="slide-caption col-md-4">
									<h2 class="slide-title">Group and Road Trips</h2>
									<p>Have awesome experiences and travel as a group </p>
								</div>
							</div>
						</li>
						<li data-background="dummy/group.jpeg" style="background-repeat: no-repeat; background-size: cover;">
							<div class="container">
								<div class="slide-caption col-md-4">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								<article class="offer wow bounceIn" data-wow-delay=".6s">
									<figure class="featured-image"><img src="dummy/offer-thumbnail-4.jpg" alt=""></figure>
									<h2 class="entry-title"><a href="">Nemo enim ipsam voluptatem</a></h2>
									<p>Piditate non provident similique	 sunt in culpa qui oficia deserunt molitia animi est aborum et dolorum fuga</p>
									<a href="#" class="button">See details</a>
								</article>
